/* This program is written by Professor Mohan. The program 
can be used to easily perform File based operations such as 
...
public class FileUtility {
	...
	private Path path;
	private int index = 0;
	/* If you would like direct access to this list of lines, 
	you can get it by changing this variable to public. 
	Then you can call lines on any instance of FileUtility and 
	use regular list methods like get(int index) */
	private List<String> lines;
	/**
	* Creates a FileUtility object that uses the specified 
	filename
	*
	* Note: make sure the file that you are using has a newline 
	at the very end
	*/
